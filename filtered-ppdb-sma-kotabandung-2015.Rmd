...
plot_pg <- function(option_id, name) {
  ...
  plot <- ggplot(df, aes(x=snapshottime, y=pg_dw)) +
    ...
    geom_line(aes(y=median_dw), color='#00aa00', linetype='dashed') +
    ...
    geom_line(aes(y=median_lw), color='#1111ee', linetype='dashed') +
    ...
    geom_line(aes(y=median_lk), color='red', linetype='dashed') +
